...
import { useGetProductsQuery,useGetSalesQuery } from "../../features/api/apiSlice";
...
const Products = () => {
  ...
  const{data:products,error}=useGetProductsQuery({color:color,size:size,sort:sort,limit:limit,offset:0,min_price:minPrice,max_price:maxPrice});
  ...
  return (
     <div className=" pt-29 md:pt-23 w-[95%] md:w-[768px] lg:w-[976px] xl:w-[1440px] mx-auto flex flex-col items-center justify-center gap-3 xl:min-h-[800px] ">
       <div className="bg-white rounded-lg flex justify-center md:justify-start md:px-3 items-center gap-1.5 w-full py-4">
        ...
        <p className="text-sm text-gray-500 cursor-pointer hover:underline">{t("shop.all_products")}</p>
