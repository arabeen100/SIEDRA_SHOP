...
const Profilecard = () => {
  ...
  return (
    <div className="w-full rounded-2xl bg-white flex flex-col items-center   min-[1440px]:w-[296.8px] min-[1440px]:gap-13 gap-7">
        ...
        <div className="flex min-[1440px]:flex-col  gap-2 sm:gap-3 justify-center  pb-13 w-[95%]  ">
            <Link to={"/profile"} className={` text-gray-600 min-[1440px]:w-[256.797px] min-[1440px]:text-sm  min-[1440px]:py-1.5  text-xs hover:bg-purple-300 px-2 font-semibold text-center py-3 cursor-pointer rounded-md grid place-content-center sm:text-[16px] sm:font-medium text-gray-600 ${pathname==="/profile"&&"bg-purple-600 text-white hover:bg-purple-500"}  `}>{t("navbar.profile")}</Link>
            <Link to={"/update-profile"} className={`${pathname==="/update-profile"&&"bg-purple-600 text-white hover:bg-purple-500"}    min-[1440px]:w-[256.797px] min-[1440px]:text-sm  min-[1440px]:py-1.5  text-xs hover:bg-purple-300 px-2 font-semibold text-center py-3 cursor-pointer rounded-md grid place-content-center sm:text-[16px] sm:font:medium  text-gray-600  `}>{t("update_profile")}</Link>
            <Link to={"/myorders"} className={` ${pathname==="/myorders"&&"bg-purple-600 text-white hover:bg-purple-500"}     min-[1440px]:w-[256.797px] min-[1440px]:text-sm  min-[1440px]:py-1.5  text-xs hover:bg-purple-300 px-2 font-semibold text-center py-3 cursor-pointer rounded-md grid place-content-center sm:text-[16px] sm:font-medium text-gray-600  `}>{t("navbar.orders")}</Link>
        </div>
